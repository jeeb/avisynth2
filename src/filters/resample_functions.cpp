...
int* ResamplingFunction::GetResamplingPatternRGB( int original_width, double subrange_start, double subrange_width,
                              int target_width, IScriptEnvironment* env )
/**
...
int* ResamplingFunction::GetResamplingPatternYUV( int original_width, double subrange_start, double subrange_width,
                              int target_width, bool luma, BYTE *temp,
