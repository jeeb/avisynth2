...
PVideoFrame __stdcall AdjustFocusV::GetFrame(int n, IScriptEnvironment* env) 
{
	...
	uc* linea = (uc*)(((INT_PTR)line+15) & -16); // Align 16
...
void AFV_MMX(const uc* l, const uc* p, const int height, const int pitch, const int row_size, const int amount) {
	...
	__m128i cw, ow;
	const static __m128i r6 = {32,0,32,0,32,0,32,0,32,0,32,0,32,0,32,0};
	const static __m128i r7 = {64,0,64,0,64,0,64,0,64,0,64,0,64,0,64,0};
	...
	for (y=0;y<height-1;y++) {
		for (i=0; i<row_size; i+=8) {
			...
			XMM4 = _mm_adds_epi16(XMM1, XMM2);
			XMM4 = _mm_packus_epi16(XMM4, XMM0);
			_mm_storel_epi64((__m128i*)(p+i+y*pitch), XMM4);
		}
	}
	// Bottom line, use current line for next
	for (i=0; i<row_size; i+=8) {
		XMM2 = _mm_loadl_epi64((__m128i*)(p+i+(height-1)*pitch));
		XMM1 = _mm_loadl_epi64((__m128i*)(l+i));
		XMM2 = _mm_unpacklo_epi8(XMM2, XMM0);
		XMM1 = _mm_unpacklo_epi8(XMM1, XMM0);
		XMM3 = _mm_mullo_epi16(XMM2, cw);
		XMM1 = _mm_adds_epi16(XMM1, XMM2);
		XMM3 = _mm_adds_epu16(XMM3, r6);
		XMM1 = _mm_mullo_epi16(XMM1, ow);
		XMM3 = _mm_srai_epi16(XMM3, 6);
		XMM1 = _mm_adds_epu16(XMM1, r7);
		XMM1 = _mm_srai_epi16(XMM1, 7);
		XMM4 = _mm_adds_epi16(XMM1, XMM3);
		XMM4 = _mm_packus_epi16(XMM4, XMM0);
		_mm_storel_epi64((__m128i*)(p+i+(height-1)*pitch), XMM4);
	}
...
void AFH_YV12_MMX(uc* p, int height, const int pitch, const int row_size, const int amount) 
{
	...
	__m128i cw, ow;
	// stupid __m128i union is declared as an array of bytes (char)
	// and it's backwards (to my way of thinking)
	const static __m128i r6 = {32,0,32,0,32,0,32,0,32,0,32,0,32,0,32,0};
	const static __m128i r7 = {64,0,64,0,64,0,64,0,64,0,64,0,64,0,64,0};
	cw = _mm_set1_epi16((amount+0x100)>>9);
	ow = _mm_set1_epi16((0x8000-amount+0x100)>>9);
	...
	for (y=0; y<height; y++) {
		...
		XMM3 = _mm_unpacklo_epi8(XMM3, XMM0);
		XMM1 = _mm_shufflelo_epi16(XMM1, 0xE5); // 11100101b
		...
		XMM2 = _mm_srai_epi16(XMM2, 6);
		XMM1 = _mm_srai_epi16(XMM1, 7);
		XMM2 = _mm_adds_epi16(XMM1, XMM2);

		XMM7 = _mm_packus_epi16(XMM2, XMM0);

		// middle
		for(i=8; i<(row_size-8); i+=8) {
			XMM4 = _mm_loadl_epi64((__m128i*)(p+y*pitch+i-1));
			XMM1 = _mm_loadl_epi64((__m128i*)(p+y*pitch+i));
			_mm_storel_epi64((__m128i*)(p+y*pitch+i-8), XMM7);
			XMM1 = _mm_unpacklo_epi8(XMM1, XMM0);
			XMM4 = _mm_unpacklo_epi8(XMM4, XMM0);
			XMM3 = _mm_loadl_epi64((__m128i*)(p+y*pitch+i+1));

			XMM1 = _mm_mullo_epi16(XMM1, cw);
			XMM3 = _mm_unpacklo_epi8(XMM3, XMM0);
			XMM4 = _mm_adds_epi16(XMM4, XMM3);
			XMM4 = _mm_mullo_epi16(XMM4, ow);
			XMM4 = _mm_adds_epu16(XMM4, r7);
			XMM1 = _mm_adds_epu16(XMM1, r6);
			XMM4 = _mm_srai_epi16(XMM4, 7);
			XMM1 = _mm_srai_epi16(XMM1, 6);
			XMM4 = _mm_adds_epi16(XMM4, XMM1);

			XMM7 = _mm_packus_epi16(XMM4, XMM0);
		}
		...
		XMM3 = _mm_shufflehi_epi16(XMM3, 0xA4); // 10100100b
		XMM2 = _mm_mullo_epi16(XMM2, cw);
		XMM1 = _mm_adds_epi16(XMM1, XMM3);
		XMM1 = _mm_mullo_epi16(XMM1, ow);
		XMM1 = _mm_adds_epu16(XMM1, r7);
