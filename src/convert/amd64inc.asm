...
; AD: I wrote this file for general use before it was part of x264.
; Hence it's not really (C) x264 project. In fact the first project that 
; I used it for was a 64-bit build of AC3-ACM.
